...
<div class="header navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="header-inner">
        ...
        <a class="navbar-brand" href="index.html">
            <img src="${base}/img/logo.png" alt="logo" class="img-responsive" />
        </a>
        <!-- END LOGO -->
        <!-- BEGIN RESPONSIVE MENU TOGGLER -->
        <a href="javascript:;" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            <img src="${base}/img/menu-toggler.png" alt="" />
        </a>
                        ...
                        <ul class="dropdown-menu-list scroller" style="height: 250px;">
                            <li>
                                <a href="inbox.html?a=view">
                                    <span class="photo"><img src="${base}/img/avatar2.jpg" alt=""/></span>
                                    <span class="subject">
                           ...
                           auctor nibh...
                            ...
                            <li>
                                <a href="inbox.html?a=view">
                                    <span class="photo"><img src="${base}/img/avatar3.jpg" alt=""/></span>
                                    <span class="subject">
                           ...
                           auctor nibh...
                            ...
                            <li>
                                <a href="inbox.html?a=view">
                                    <span class="photo"><img src="${base}/img/avatar1.jpg" alt=""/></span>
                                    <span class="subject">
